/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 59d9d1a00f92366f60807f267a1811fc)
...
declare namespace Cloudflare {
	...
	interface Env {
		RATE_LIMITER: DurableObjectNamespace /* IpRateLimiter */;
		AI: Ai;
	}
}
