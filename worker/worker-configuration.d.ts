/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 5f12e70d7861a873b2e40e92dd568a7e)
...
declare namespace Cloudflare {
	...
	interface Env {
		ADMIN_INDEX_KEY: string;
		RATE_LIMITER: DurableObjectNamespace<import("./index").IpRateLimiter>;
		ASSETS: R2Bucket;
