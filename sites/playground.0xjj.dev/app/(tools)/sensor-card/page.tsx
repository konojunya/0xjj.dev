...
const tool = tools.find((t) => t.slug === 'sensor-card')!;

export const metadata = createToolMetadata('sensor-card');

export default function Page() {
  trackView('sensor-card');
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: createToolJsonLd('sensor-card') }} />
      <div className="py-6">
