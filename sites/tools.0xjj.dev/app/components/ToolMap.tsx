...
export default function ToolMap() {
  ...
  return (
    <>
      ...
      <style>{`
        @supports (anchor-name: --tool-map-anchor) {
          #tool-map-btn { anchor-name: --tool-map-anchor; }
          #tool-map-popover {
            position: fixed;
            position-anchor: --tool-map-anchor;
      ...
      <div ref={ref} className="relative">
        ...
        {open && (
          <div
            id="tool-map-popover"
            className="absolute right-0 top-10 z-50 w-72 overflow-hidden rounded-2xl border border-[color-mix(in_srgb,var(--color-fg)_12%,transparent)] bg-bg shadow-lg"
          >
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {active && (
                            <span className="rounded-full border border-[color-mix(in_srgb,var(--color-fg)_15%,transparent)] px-1.5 py-0.5 font-mono text-[10px] leading-none text-muted">
                              current
                            </span>
                          )}
                        </div>
