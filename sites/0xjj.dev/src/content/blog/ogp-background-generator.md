...
試しにこの強度を `1.0`（100%）にするとどうなるかを見てみます。blob の色がベースカラーをほぼ完全に上書きして、各色がくっきり主張しすぎています。

![](https://0xjj.dev/images/blog/ogp-background-generator/strength-100.png)

55% に抑えることで、色同士が穏やかに溶け合うパステルらしい印象になります。
...
半径の違いでどれくらい仕上がりが変わるかを見てみます。半径 5 だと blob の輪郭がまだ残っており、個々の色の配置がはっきり見えます。
